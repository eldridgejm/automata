"""Initialize a new coursepage from a template."""
...
def initialize(path):
    ...
    with (path / "config.yaml").open("a") as fileobj:
        ...
        fileobj.write(
            "    content: This is an **announcement box** element. "
        ...
        fileobj.write(
            "\n".join(
                [
                    ...
                    "See the documentation for how to add *elements* to the page.",
                    "Elements are useful for displaying the course schedule, etc.",
                    "",
