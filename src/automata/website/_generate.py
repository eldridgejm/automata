...
def _render_page(
    ...
    """
    with (content_path / relative_path_to_page).open() as fileobj:
    ...
    page_html = _interpolate(BASE_THEME, {"body": body_html, **context._asdict()})

    output_page_abspath = (output_path / relative_path_to_page).with_suffix(".html")
