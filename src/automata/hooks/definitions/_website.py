...
from .._base import HookBase, ScriptableHookMixin, WebsiteContent, hook_point
...
class PreGenerateWebsiteHook(HookBase):
...
class PostGenerateWebsiteHook(HookBase, ScriptableHookMixin):
