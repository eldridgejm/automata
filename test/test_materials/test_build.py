...
def test_build_artifact_integration(default_example_course):
    ...
    # when
    result = automata.materials.build_node(artifact)
...
def test_build_artifact_when_release_time_is_in_future():
    ...
    # when
    result = automata.materials.build_node(artifact, run=run, now=now)
...
def test_build_artifact_when_release_time_is_in_future_ignore_release_time():
    ...
    # when
    result = automata.materials.build_node(
...
def test_build_artifact_when_recipe_is_none():
    ...
    # when
    result = automata.materials.build_node(artifact, run=run, exists=exists)
...
def test_build_artifact_raises_if_no_file():
    ...
    # when
    with raises(automata.materials.BuildError):
        automata.materials.build_node(artifact, run=run, exists=exists)
...
def test_build_collection(default_example_course):
    ...
    # when
    built_universe = automata.materials.build_node(universe)
